...
namespace FurnitureDBCrudMVCCore.Controllers
{
    public class FurnituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FurnitureId,FurnitureName,Rate,Description,CategoryId")] Furniture furniture)
        {
            ...
            ViewData["CategoryId"] = new SelectList(_context.Category, "CategoryId", "CategoryName", furniture.CategoryId);
            return View(furniture);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> SearchByCategoryResult(SearchByCategoryViewModel model)
        {
            var searchResult = await _context.Furniture
                .Include(f => f.Category)
